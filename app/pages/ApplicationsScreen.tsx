...
function ApplicationsScreen(): React.JSX.Element {
  ...
  const data: Data[] = [
    ...
    { id: '4', title: 'Test content box', subtitle: 'content box', icon: ['fas', 'dragon'], iconColor: 'primary' },
    ...
    { id: '8', title: 'Test content box', subtitle: 'content box', icon: ['fas', 'dragon'], iconColor: 'yellow' },
    ...
    { id: '12', title: 'Test content box', subtitle: 'content box', icon: ['fas', 'dragon'], iconColor: 'green' },
